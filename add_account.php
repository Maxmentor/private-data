...
if(isset($_POST['add_acc'])) {
    ...
    $sql = "INSERT INTO accounts (user_id, category_id, email, mobile, recovery_mail, backup_code, password) 
            VALUES ('$user_id', '$cat_id', '$email', '$mobile', '$recovery', '$backup', '$password')";
    
    if($conn->query($sql)) {
        $msg = "<div class='alert alert-success'>Account Saved Successfully!</div>";
    }
}
?>
<!DOCTYPE html>
...
<div class="container mt-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header  text-white"><h4>Add New Account</h4></div>
        <div class="card-body">
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="recovery_mail" class="form-control">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Backup Codes</label>
                        <textarea name="backup_code" class="form-control" rows="2"></textarea>
                    </div>
                </div>
                <button type="submit" name="add_acc" class="btn btn-success">Save Account</button>
            </form>
        </div>
    </div>
</div>
